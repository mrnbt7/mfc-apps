...
// MyMTLD.cpp : Defines the class behaviors for the application.
//
...
CMyMTLDApp::CMyMTLDApp() noexcept
{
	...
	SetAppID(_T("MyMTLD.AppID.NoVersion"));
...
// CMyMTLDApp initialization

BOOL CMyMTLDApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMyMTLDDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CMyMTLDView));
	if (!pDocTemplate)
		return FALSE;
